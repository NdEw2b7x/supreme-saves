import { Element, WeaponCategory, Name } from '../../types';
  ...
  skill: {
    ...
    circuit: {
      ...
      skill: [
        ...
        genATKDamageNode([[0.3922], [0.1308], [0.1308]], '하늘로 향해 · 일반 공격 2단', 'basic'),
        genATKDamageNode([[0.5002], [0.3335]], '하늘로 향해 · 일반 공격 3단', 'basic'),
        genATKDamageNode([[0.0939, 6], [0.3756]], '하늘로 향해 · 일반 공격 4단', 'basic'),
        genATKDamageNode([[0.24], [0.56]], '하늘로 향해 · 강공격', 'heavy'),
        genATKDamageNode([[0.2208], [0.1656, 2], [0.5519]], '하늘로 향해 · 회피 반격'),
        genATKDamageNode([[0.5068], [0.3801, 2], [1.267]], '달을 품은 용녀', 'skill'),
      ...
      circuit: { name: '봄의 빛', max: 50 },
    },
    liberation: { name: '만물의 정화', skill: [genATKDamageNode([[2.514], [5.866]])] },
    intro: {
      name: '반룡의 빛',
